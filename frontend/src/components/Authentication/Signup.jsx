    ...
    return(
        <div className="signup_page">
            ...
            <div className="signup_terms">
                <p id="terms">By signing up, you agree to Chopee's <a href="#">Terms and Service </a> & <a href="#">Privacy Policy</a></p>
            </div>
            <div className="login">
                <p>Have an Account? <Link to="/user/auth/login"><span id="signup_link"> Login </span> </Link></p>
            </div>
        </div>
    );
}
